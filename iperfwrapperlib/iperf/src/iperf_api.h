...
void    iperf_set_test_interval(struct iperf_test *ipt, int interval_ms);
...
void	iperf_set_test_protocol( struct iperf_test* ipt, char protocol);
void    iperf_set_test_template( struct iperf_test *ipt, char *tmp_template );
void    iperf_set_test_udp_bandwidth( struct iperf_test *ipt, char *bandwidth );
